...
def __generate_screenshots(dest_path: Path):
    ...
    widget = QgsHillshadeRendererWidget(layer)

    im = ScreenshotUtils.capture_widget(widget, width=390)
    im.save((dest_path / "hillshaderendererwidget.png").as_posix())

    return {"hillshaderendererwidget.png": "QgsHillshadeRendererWidget"}
