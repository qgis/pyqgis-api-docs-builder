...
def __generate_screenshots(dest_path: Path):
    ...
    im = ScreenshotUtils.capture_dialog(widget, width=490, height=220)
    im.save((dest_path / "advanceddigizitingdockwidget.png").as_posix())

    return {"advanceddigizitingdockwidget.png": "QgsAdvancedDigitizingDockWidget"}
